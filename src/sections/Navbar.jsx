...
const Navbar = () => {
    ...
    return (
        <>
                        ...
                        <div className='flex flex-col flex-wrap md:flex-row gap-x-2'>
                            {socials.map((social, index) => (
                                <a
                                    key={index}
                                    href={social.href}
                                    className='text-sm leading-loose tracking-wider uppercase hover:text-white transition-colors duration-300'
                                >
                                    {"{"}{social.name}{"}"}
                                </a>
                            ))}
            ...
            <div
                className='fixed z-50 flex flex-col items-center justify-center gap-1 transition-all duration-300 bg-black rounded-lg cursor-pointer w-12 h-12  lg:w-12 lg:h-12 top-4 right-6'
                onClick={toggleMenu}
